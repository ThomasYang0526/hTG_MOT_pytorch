...
class JDETracker(object):
    def __init__(self, frame_rate=30):
        ...
        self.model = MyResNet50()
        self.model.load_state_dict(torch.load('./saved_model/resnet50FPN_256_epoch_{}.pth'.format(config.finetune_load_epoch)))
    ...
    def update(self, im_blob, img0):
        ...
        with torch.no_grad():
            pred = self.model(im_blob, tid = torch.ones((1, 100)).cuda())
        bboxes, scores, clses, id_feature = Decoder(pred, (img0.shape[0], img0.shape[1]))
